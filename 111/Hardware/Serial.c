...
void Serial_USART2_Init(int bound){
	...
	if     (bound ==230400) 	baud = 0;
	else if(bound ==460800) 	baud = 1;
	else if(bound ==512000)	baud = 2;
	else if(bound ==921600) 	baud = 3;//这是stm32最高的波特率，理论是4.5M,但可达到这个9.2MHz
	else if(bound ==1500000) baud = 4;
	SMD15_init(baud);
}
